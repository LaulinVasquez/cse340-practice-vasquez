...
const getSortedSections = (sections, sortBy) => {
  ...
  switch (sortBy) {
    ...
    case "time":
    default:
      return sortedSections; // Keep the same original order
  }
};

const getCoursesByDepartment = () => {
    const departments = {};
    // This block of code what is doing is creating a new dynamic object if a 
    // department does not exist then create a new dynamic erray and push all details to create an object
